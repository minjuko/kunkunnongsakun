...
urlpatterns = [
    ...
    path(
        'session_details/<str:session_id>/',
        views.prediction_session_details,
        name='prediction_session_details',
    ),
    path(
        'delete_session/<str:session_id>/',
        views.delete_prediction_session,
        name='delete_prediction_session',
    ),
    ...
    path(
        'update_session_name/<str:session_id>/',
        views.update_session_name,
