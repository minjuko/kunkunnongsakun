...
class CapabilityApiTests(SimpleTestCase):
    ...
    def test_missing_configuration_is_reported_without_secret_details(self, _artifact_available):
    ...
    def test_configured_services_are_reported_available(self, _model_available, _index_available):
