...
DATABASE_ROUTERS = ['config.db_routers.SchemaRouter']
...
if USE_S3:
    ...
    STORAGES = {
        'default': {'BACKEND': 'common.storage_backends.MediaStorage'},
        'staticfiles': {'BACKEND': 'common.storage_backends.StaticStorage'},
    }
else:
    STORAGES = {
